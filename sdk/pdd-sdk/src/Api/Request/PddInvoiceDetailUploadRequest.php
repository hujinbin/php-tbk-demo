...
class PddInvoiceDetailUploadRequest extends PopBaseHttpRequest
{
	...
	*/
	...
	/**
	* @JsonProperty(List<\Com\Pdd\Pop\Sdk\Api\Request\PddInvoiceDetailUploadRequest_InvoiceItemListItem>, "invoice_item_list")
	*/
	...
	*/
	...
	/**
	* @JsonProperty(Integer, "paper_shipping_id")
	*/
	private $paperShippingId;

	/**
	* @JsonProperty(String, "paper_tracking_number")
	*/
	private $paperTrackingNumber;
	...
	*/
	...
	protected function setUserParams(&$params)
	{
		...
		$this->setUserParam($params, "invoice_item_list", $this->invoiceItemList);
		...
		$this->setUserParam($params, "paper_shipping_id", $this->paperShippingId);
		$this->setUserParam($params, "paper_tracking_number", $this->paperTrackingNumber);
	...
	public function setPaperShippingId($paperShippingId)
	{
		$this->paperShippingId = $paperShippingId;
	}

	public function setPaperTrackingNumber($paperTrackingNumber)
	{
...
class PddInvoiceDetailUploadRequest_InvoiceItemListItem extends PopBaseJsonEntity
{
