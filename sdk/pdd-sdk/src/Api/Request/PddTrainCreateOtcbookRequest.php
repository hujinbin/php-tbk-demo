...
class PddTrainCreateOtcbookRequest extends PopBaseHttpRequest
{
	...
	*/
	...
	/**
	* @JsonProperty(Integer, "order_type")
	*/
	private $orderType;

	/**
	* @JsonProperty(String, "order_deadline")
	*/
	...
	protected function setUserParams(&$params)
	{
		...
		$this->setUserParam($params, "order_type", $this->orderType);
		$this->setUserParam($params, "order_deadline", $this->orderDeadline);
