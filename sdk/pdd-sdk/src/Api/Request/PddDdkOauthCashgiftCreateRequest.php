...
class PddDdkOauthCashgiftCreateRequest extends PopBaseHttpRequest
{
	...
	*/
	...
	/**
	* @JsonProperty(List<\Com\Pdd\Pop\Sdk\Api\Request\PddDdkOauthCashgiftCreateRequest_PIdListItem>, "p_id_list")
	*/
	private $pIdList;
...
class PddDdkOauthCashgiftCreateRequest_PIdListItem extends PopBaseJsonEntity
{
